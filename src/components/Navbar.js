        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          {/* <div className="d-flex">
            <div
              ...
              style={{ height: "30px", width: "30px" , cursor:"pointer",border:'3px solid deeppink'}}
            ></div>
            <div
              className="bg-danger rounded mx-2"  onClick={() => props.toggleMode('danger')}
              style={{ height: "30px", width: "30px" , cursor:"pointer",border:'3px solid blue'}}
            ></div>
            <div
            ...
            ></div>
            <div
              className="bg-light rounded mx-2"  onClick={() => props.toggleMode('light')}
              style={{ height: "30px", width: "30px" , cursor:"pointer", border:'3px solid deeppink'}}
            ></div>
            <div
              className="bg-dark rounded mx-2"  onClick={() => props.toggleMode('dark')}
              style={{ height: "30px", width: "30px" , cursor:"pointer",border:'3px solid deeppink'}}
            ></div>
          </div> */}
